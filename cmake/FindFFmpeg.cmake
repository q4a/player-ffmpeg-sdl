...
macro(find_component COMPONENT PKGCONFIG LIBRARY HEADER)
	if(NOT WIN32)
      ...
      get_filename_component(COMPONENT_PARENT_DIR ${${COMPONENT}_INCLUDE_DIR} DIRECTORY)		
      
      # find lib
      file(GLOB_RECURSE ${COMPONENT}_LIBRARIES "${COMPONENT_PARENT_DIR}/*${COMPONENT}.lib") 
      # @todo: define definition and version
    else()
      SET(${COMPONENT}_INCLUDE_DIR NOTFOUND CACHE PATH "${COMPONENT} path")
    endif()
	endif()
